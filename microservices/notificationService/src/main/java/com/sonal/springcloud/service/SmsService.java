...
public class SmsService implements ISmsService {
 ...
 private Logger logger = LoggerFactory.getLogger(NotificationService.class);
    ...
    public NotificationServiceResponseVO getMobileNumberAndSendSMS(CoreServiceRequestVO coreServiceRequestVO) {
        ...
        ResponseEntity<CoreServiceResponseVO> exchange = this.restTemplate.exchange("http://CORESERVICE/coreService/findUser", HttpMethod.POST, requestEntity,CoreServiceResponseVO.class);
        
        CoreServiceResponseVO coreServiceResponseVO = exchange.getBody();
        
        String mobileNumber = coreServiceResponseVO.getMessage();
        
        String message = "Sent SMS to " + mobileNumber + " From Number :: " + fromNumber;
        logger.info(message);
